function [query_id] = mySVDTruncateAL(trainsamples, initL, samples_to_query_from, K, lambda, learningparams, alparams) 
global cnstData
   ...
   [ind]       = mySpectFiltTruncated(K, Lind,Uind, ytrain(Lindex), lambda );
