function [query_id] = quire_clusterredactive(trainsamples, initL, samples_to_query_from, K, lambda, learningparams, alparams) 
global cnstData
   ...
   [queryind] = QUIREclustered(K,Lind,Uind, y_Lindex, lambda );
