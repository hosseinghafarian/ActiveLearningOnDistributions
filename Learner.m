function [acc_Result, empRisk,Predict,model]...
            = Learner( isDistData,Options, ModelAndData ,initL,...
                             xTrain,     yTrain,    ...
...
%                  [ALresult1,model_set1,Y_set1]= ActiveDConvexRelaxOutlier(sw,ModelAndData,initL,unlabeled,Yl,n_l,n_u,batchSize,n_o,lnoiseper,onoiseper,lambda);
%                  ModelAndData.ALresultComp  = ALresult1;
%                  ModelAndData.model_setComp = model_set1;
%                  ModelAndData.Y_set1        = Y_set1;
                 %[ALresult,model_set,Y_set] = ActiveOutlierSaddle11(sw,ModelAndData,initL,unlabeled,Yl,n_l,n_u,batchSize,n_o,lnoiseper,onoiseper,lambda,lambda_o,YfCheck);
                 [ALresult,model_set,Y_set] = ActiveOutlierSaddle10(sw,ModelAndData,initL,unlabeled,Yl,n_l,n_u,batchSize,n_o,lnoiseper,onoiseper,lambda,lambda_o,YfCheck);
...
function [ALresult,model_set,Y_set]= ActiveDConvexRelaxOutlier(sw,ModelAndData,initL,unlabeled,Yl,n_l,n_u,batchSize,n_o,lnoiseper,onoiseper,lambda)
        ...
        %them was a function, now all are in one function for the sake of
