function MainActiveLearning01_fortest
%% Setting Solver
% Mosek
close all
...
while datasetId <= enddataset 
    ...
    %         end 
            ...
            [acc_ML, empRisk,Predict,model]...
                  = Learnerfortest(isDistData,Options,ModelAndData,initL{repeatexp,1},...
                            xTrain, yTrain, ...
...
%             ntotalQueries= batchSize+1  ;
            ...
            for query_round_numi=2:query_round_num    % while ntotalQueries+batchSize < budget/3 
                %% Calling Learner 
                [acc_ML, empRisk,Predict,model]...
                      = Learnerfortest(isDistData,Options,ModelAndData,initLcurr,...
                                xTrain, yTrain, ...
                                xTest,  yTest , queryInstance    );
                %% Calling Active Learner ( Query Selection )
                [queryInstance]...
