function [query_id] = DISTmarginsampling(trainsamples, initL, samples_to_query_from, K, lambda, learningparams, almethods_par) 
global cnstData
   xtrain                = trainsamples.DISTX; % use mean as representation of the distribution
