function [kernel_param_list, learning_param_list] = SMMOnline_make_learning_list(learning_params_ref, Classification_exp_param)
% This function makes list of fields list for cross validation for function
% SVMDIST
%
gamma_SCALE_list     = [0.1, 0.15];%:0.05:2;
