function [kernel_param_list, learning_param_list] = SMAVGM_make_learning_list(learning_params_ref, Classification_exp_param)
% This function makes list of fields list for cross validation for learning
% based on the average of vectors in the sample drawn from a distribution. 
%
gamma_SCALE_list     = 0.1:0.1:1.5;
...
learning_params_ref.KOptions.kernel_func = @AVGrbf_kernel;
n    = 0;
for i= 1:n_list
