function [query_id] = adaptregmargin(trainsamples, initL, samples_to_query_from, K, lambda, learningparams, alparams) 
% This code is not complete yet. 
% It must computes the query based on a \lambda (regularization parameter) from a set of values 
global cnstData
