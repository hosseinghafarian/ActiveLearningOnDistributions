function [query_id] = ALBoost_margin(trainsamples, initL, samples_to_query_from, K, lambda, learningparams, alparams) 
global cnstData
   lambda = alparams{1};
   t_0    = alparams{2};
   mu     = alparams{3};      
   ...
   [ind]       = Activeboost_margin(K, Lind,Uind, ytrain(Lindex), lambda ,t_0 ,mu );
