function [query_id] = SparseSimplePMAL(trainsamples, initL, samples_to_query_from, K, lambda, learningparams, alparams) 
global cnstData
   ...
   [queryind] = SparseSPMALactive(K,Lind,Uind, y_Lindex, lambda );
