function [model] = REGCASESPCF_classification(learningparams, data_train_x, data_train_y, data_train_noisy)
 % This function implements the following paper:
 % Regularization of CASE Specific Parameters for robustness and efficiency
 % Yoonkyung lee, MacEachern, Yoonush Jung, Statistical Science
 % 
    ...
    lambda_gamma = learningparams.lambda_gamma;
...
%%  Define Problem, Constraints and Objective  
    ...
    function [cConstraint, cObjective]    = constraintType(options)
        ...
        cConstraint  = [cConstraint, ksi>= ones(n,1)-1/lambda_gamma-Yl*(K*w)];
