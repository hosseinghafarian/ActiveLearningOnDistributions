function [learning_param_list] = REJ_make_learning_list(learning_params_ref, Classification_exp_param)
...
lp_vals        = combvec(d_REJ_list, gamma_SCALE_list, lambda_list);
