function [ALresult, model_set, Y_set]= ActiveDConvexRelaxOutlier(WMST_beforeStart, Model, learningparams, xTrain, yTrain)
        global cnstData
...
%%      Define Problem, Constraints and Objective  
        ...
        Options.constraintForm = 5; Options.addsumpConstraint = true; Options.addsumpobjective = false; Options.addsumqobjective = false;
