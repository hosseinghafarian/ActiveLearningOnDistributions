function [learning_param_list] = CASESPCFC_make_learning_list(learning_params_ref, Classification_exp_param)
...
lamda_gamma_list     = 0.05:0.05:1.5;
lp_vals        = combvec(lamda_gamma_list, gamma_SCALE_list, lambda_list);
n_list         = size(lp_vals,2);
learning_param_list_temp = cell(n_list,1);
n    = 0;
for i= 1:n_list
    learning_params_temp = learning_params_ref;
       learning_params_temp.lamda_gamma     = lp_vals(1,i);
