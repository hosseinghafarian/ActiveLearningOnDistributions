function [learning_param_list] = make_learning_list2(learning_params_ref, Classification_exp_param)
...
cp_list        = 0.5:0.05:1;
lp_vals        = combvec(cp_list, gamma_SCALE_list, gamma_o_SCALE_list, lambda_list, lambda_o_list);
